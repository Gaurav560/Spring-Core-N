...
public class SetterInjectionUsingSpringIOCContainerBeanFactory {
	...
	//2nd time no  object is created .it uses the same object kept in cache memory for faster execution 
